...
def FGIAnet100_R18(**kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet_DGCRL(BasicBlock, [2,2,2,2],'DGCRL_max_avg',
                   **kwargs)


def FGIAnet100_R34(**kwargs):
    r"""ResNet-50 model from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet_DGCRL(BasicBlock, [3,4,6,3],'DGCRL_max_avg',
                   **kwargs)


def FGIAnet100_R101(**kwargs):
    r"""ResNet-50 model from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet_DGCRL(Bottleneck, [3,4,23,3],'DGCRL_max_avg',
                   **kwargs)


def FGIAnet100_R152(**kwargs):
    r"""ResNet-50 model from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet_DGCRL(Bottleneck, [3,8,36,3],'DGCRL_max_avg',
                   **kwargs)
